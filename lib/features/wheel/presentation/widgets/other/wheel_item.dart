    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: AppProps.kSmallMargin),
          _buildItemRow('Тип помещения:', storage, fontWeight: FontWeight.w400, fontSize: 12),
          const SizedBox(height: AppProps.kSmallMargin),
          _buildItemRow('Тип действия:', typeAction, fontWeight: FontWeight.w400, fontSize: 12),
          const SizedBox(height: AppProps.kSmallMargin),
